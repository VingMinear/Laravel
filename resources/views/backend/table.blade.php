                                        ...
                                        @foreach ($rooms as $data)
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    <span
                                                        class="text-secondary text-xs font-weight-bold">{{ $data->room_desc }}</span>
                                                </td>
                                                <td class="align-middle pt-3 text-center">
                                                    ...
                                                    <a href="{{route('room.edit',$data->room_id)}}" class="btn btn-primary px-3" data-toggle="tooltip"
                                                        data-original-title="Edit user">
                                                        <img src="{{ asset('./assets/icons/edit.svg') }}" alt="SVG Image">
                                                    </a>
                                                    <a href="{{route('room.delete',$data->room_id)}}" class="btn btn-danger px-3"
